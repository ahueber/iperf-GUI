...
NumPad::NumPad(Client *c) : client(c) {
  ...
  panel->setStyleSheet(
      "QLabel { font-size: 60px; background-color: #666666; color: #ffffff; }");
  ...
  QObject::connect(btnDone, SIGNAL(clicked()), this,
                   SLOT(onButtonDoneClicked()));
  QObject::connect(btnBksp, SIGNAL(clicked()), this,
                   SLOT(onButtonBkspClicked()));
...
void NumPad::onButtonZeroClicked() { this->addString("0"); }

void NumPad::onButtonOneClicked() { this->addString("1"); }

void NumPad::onButtonTwoClicked() { this->addString("2"); }

void NumPad::onButtonThreeClicked() { this->addString("3"); }

void NumPad::onButtonFourClicked() { this->addString("4"); }

void NumPad::onButtonFiveClicked() { this->addString("5"); }

void NumPad::onButtonSixClicked() { this->addString("6"); }

void NumPad::onButtonSevenClicked() { this->addString("7"); }

void NumPad::onButtonEightClicked() { this->addString("8"); }

void NumPad::onButtonNineClicked() { this->addString("9"); }

void NumPad::onButtonDotClicked() { this->addString("."); }
